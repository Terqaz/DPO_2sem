...
// Аутентификатор при входе пользователя
class LoginAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    /** Обработчик события после успешной аутентификации
     * @param $request - HTTP-запрос
     * @param $token - хранилище токена пользователя
     * @param $firewallName - имя файерволла
